...
namespace runnerDotNet
{
    ...
    [JsonConverter(typeof(XVarConverter))]
    public partial class XVar : IComparable<XVar>
    {
        #region Properties
        ...
        public XVar Replace(XVar oldValue, XVar newValue, bool caseInsensitive = false)
        {
            ...
            StringComparison compare = caseInsensitive ? StringComparison.CurrentCultureIgnoreCase : StringComparison.CurrentCulture;
        ...
        public bool IsArray()
        {
			return this.value != null && (this.Type == typeof(Dictionary<XVar, XVar>) || (this.Type == typeof(XSettingsMap) && (this.Value as XSettingsMap).IsArray()));
        }

        public bool IsProperArray()
        {
            if (this.Type == typeof(Dictionary<XVar, XVar>) || (this.Type == typeof(XSettingsMap) && (this.Value as XSettingsMap).IsArray()))
            {
        ...
        public override string ToString()
        {
            ...
            else if( this.value is System.Byte[] )
				return System.Text.Encoding.Default.GetString( (System.Byte[])this.value);
			else 
				return CSmartStr(value);
        }
	...
	/// </summary>
	public class SettingsMap : Dictionary<String, SettingsMap>
	{
		public XVar _x;
